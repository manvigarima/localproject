...
$al=".";
	...
	$totalEntries=$feedback1->totalNoOffeedback1($al,$_SESSION['school_id']);
	...
	$rec = $feedback1->display_feedback1($page,$order,$al,$_SESSION['school_id']);	
/*	echo"<pre>";
	print_r($rec);
*/	
					...
					<table class="global" width="100%"  cellpadding="0" cellspacing="0"> 
						<thead>
						 ...
						 <tr><td width="100%" colspan="5"><b><?php echo $_SESSION['msg']; if(!empty($_SESSION['msg']))unset($_SESSION['msg']);?></b></td></tr>
											...
											if($arr['email_id'] != ''){ echo $arr['email_id']; }
											?></td>
										                  <td align="left"><?=$row['fb_message'];?></td>
										                  <td align="left">
                                                         
                                                          <a href="action.php?<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."&";}if(!empty($_REQUEST['or'])){echo "or=".$_REQUEST['or']."&";}?>id_1=<?=$row['fb_id']?>&id=<?=$row['fb_id']?>&state=<?php echo $row['status'];?>&page=<?php echo $page; ?>&order=<?php echo $order;?>">
														  <?php 
											...
											?></td>
										                  <td align="left"><?=$row['fb_message'];?></td>
										                  <td align="left">
                                     <a href="action.php?<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."&";}if(!empty($_REQUEST['or'])){echo "or=".$_REQUEST['or']."&";}?>id_1=<?=$row['fb_id']?>&id=<?=$row['fb_id']?>&state=<?php echo $row['status'];?>&page=<?php echo $page; ?>&order=<?php echo $order;?>"><?php 
														  if($row['status']=="active")
														  echo"Active";
														  else
														  echo"Inactive";
