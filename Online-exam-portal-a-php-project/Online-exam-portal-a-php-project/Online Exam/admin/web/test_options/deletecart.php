<?php
 ...
 $exams_bag->bag_delete(bagid,$id);


				/*print "<script>";
				print " self.location='manage_cart.php?userid=".$user['user']."&msg=Test Was Deleted';";
				print "</script>";*/

$msg="Test Was Deleted";
//header("location:manage_cart.php?msg=".$user['user']." Test Was Deleted ");
?>
<?php
	include_once'../../../lib/db.php';
	include_once'../../../lib/class_exam_bag.php';
