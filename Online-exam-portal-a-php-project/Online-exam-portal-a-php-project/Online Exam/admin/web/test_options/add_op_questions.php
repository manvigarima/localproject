<?php session_start();
include "../../../lib/db.php";
include "../../../lib/ise_Settings.class.php";
$settings=new ise_Settings();

 //include "secure.php";?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<?php include"../header_one.php";?>
    ...
    <div id="content_wrapper" style="margin-right:30px;"> 
			...
			<li> 
				...
				<li> 
					<a href="<?php echo $admin_path;?>test_options/add_op_questions.php" class="active"> 
...
$exams_optque->optque_insert($tab);


$_SESSION['msg'] = "<font size='2' color='#FF0000'>Optional question is added successfully</font>";
...
<form name="questions_form"  method="post" enctype="multipart/form-data" onsubmit="return check()">
                      ...
                      <td align="left"><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                          <tbody><tr>
                            <td><table summary="Buttons" width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <!--  <tr>
                                    <td colspan="2" class="h2" height="30"><span class="ph"><strong>Manage Subject</strong></span></td>
                                  </tr>-->
							...
							{
							$allcurri = $exams_curriculum->curriculum_allname_select();
...
<tr valign="middle">
                                          <td class="tr2" align="right"><label>Section A</label></td><td colspan="2" class="tr2" align="left" height="26"><div id="chap"><input type="text" name="seca" value ="" ></div></td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right"><label> Marks for Section A </label> </td>
                                          <td colspan="2" class="tr2" align="left" ><input type="text" name="amarks" value ="" >
                                        </td>
                                        </tr>
                                      <tr valign="middle">
                                          <td class="tr2" align="right"><label>Section B </label></td>
                                          <td colspan="2" class="tr2" align="left"><input type="text" name="secb" value ="" >
                                        </td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right"> <label>Marks for Section B  </label></td>
                                          <td colspan="2" class="tr2" align="left"><input type="text" name="bmarks" value ="" >
                                        </td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right"><label>Section C </label></td>
                                          <td colspan="2" class="tr2" align="left"><input type="text" name="secc" value ="" >
                                        </td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right"><label> Marks for Section C</label>  </td>
                                          <td colspan="2" class="tr2" align="left" ><input type="text" name="cmarks" value ="" >
                                        </td>
                                        </tr>
                                         <tr valign="middle">
                                          <td class="tr2" align="right"><label>Section D</label> </td>
                                          <td colspan="2" class="tr2" align="left" ><input type="text" name="secd" value ="" >
                                        </td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right"><label> Marks for Section D </label> </td>
                                          <td colspan="2" class="tr2" align="left"><input type="text" name="dmarks" value ="" >
                                        </td>
                                        </tr>
...
<tr valign="middle">
                                          <td colspan="5" class="pagesnum" align="center"><input type="submit" name='submit' value='Submit' class="button_light"></td>
                                        </tr>                  </table>
