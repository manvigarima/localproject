<?php session_start(); //include "secure.php";
include "../../../lib/db.php";
...
$where =array("num=".$num."");
$page=$_REQUEST['page'];
$exams_optque->optque_update($tab,$where);
$_SESSION['msg'] = "<font size='2' color='#FF0000'>Optional question is updated successfully</font>";
...
<form name="questions_form" action="" method="post" enctype="multipart/form-data" onsubmit="return check()">
                          ...
                          <tbody><tr>
                            <td><table summary="Buttons" width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                  ...
                                  <tr>
                                    <td colspan="2" class="h2" ><span class="ph"><strong>Manage Subject</strong></span></td>
                                  </tr>
							...
							?>
                              ...
                              <table width="100%" border="1" cellpadding="10" cellspacing="0">
                                ...
                                <tr valign="middle">
                                          <td class="tr2" align="right" height="26"><label>Curriculum</label></td><td colspan="2" class="tr2" align="left" height="26">
										  <?php
										
										$opt_que = $exams_optque->optque_select_rows(num,$num);
										...
										<tr>
                                          <td class="tr2" align="right" width="50%"><label>Subject</label></td>
                                          <td colspan="2" class="tr2" align="left" height="26">	<?=$sname["sub_name"]?>  </td>
                                        </tr> 
                                           <tr>
                                          ...
                                          <td colspan="2" class="tr2" align="left"><input type="text" name ="seca" value="<?=$row["section_a"]?>"  /> option  numbers must be 0 or  above 1. saparated by ','</td>
                                        </tr>
                                        <tr valign="middle">
                                      ...
                                      <tr valign="middle">
                                          ...
                                          <td colspan="2" class="tr2" align="left"><input type="text" name ="secb" value="<?=$row["section_b"]?> " />option  numbers must be 0 or  above 1 by ','</td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right"><label>Marks for Section B </label></td>
                                          <td colspan="2" class="tr2" align="left" height="26"><input type="text" name="bmarks" value ="<?=$row["bmarks"]?>" >
                                        </td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right" ><label>Section C </label></td>
                                          <td colspan="2" class="tr2" align="left" height="26"><input type="text" name ="secc" value="<?=$row["section_c"]?> "/> option  numbers must be 0 or  above 1 by ',' </td>
                                        </tr>
                                        <tr valign="middle">
                                          <td class="tr2" align="right" ><label>Marks for Section C </label></td>
                                          <td colspan="2" class="tr2" align="left" ><input type="text" name="cmarks" value ="<?=$row["cmarks"]?>" >
                                        </td>
                                        </tr>
                                          <tr valign="middle">
                                          <td class="tr2" align="right"><label>Section D </label></td>
                                          <td colspan="2" class="tr2" align="left" height="26"><input type="text" name ="secd" value="<?=$row["section_d"]?> "/> option  numbers must be 0 or  above 1 by ',' </td>
                                        </tr>
                                        <tr valign="middle">
