...
$exams_grades = new exams_grades();
										...
										$opt_que = $exams_optque->optque_select_one();
										$rowcount=0;
										//print_r($opt_que);
										$rowcount=0;
										if(is_array($opt_que)){
										...
										<tr  bgcolor='#72ACF3'>
										<td>Search Criteria: Questions</td> 
										<td>Total Records: ".count($opt_que)."</td></tr>
										<tr><td colspan='2' align='center' style='color:#336699; font-size:16px;'><strong>Questions</strong></td></tr>";
