<?php 
	...
	$val = $blog->blog_review_view($_GET['id']);	
			...
			<form name="newsSelectForm" method="post" action="delete_news.php?al=<? echo $_REQUEST['al'];?>&page=<? echo $page; ?>">
									<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" class="global">
										<tbody>
											...
											<tr>
												<td align="left" colspan="5"><h3>View Blog Review</h3></td>
											</tr>
												...
												<td colspan="5">
													<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tborder">
													  ...
													  <tr class="row_white">
										                  ...
										                  <td width="18%" align="left"><span class="sideheading">User Name</span></td>
                                                        <td width="7%" align="left">:</td>
									                    <td width="45%" align="left"><?php $value = $ise_users->ise_users_select('user_fname','user_id',$val['user_id']);if($value!='') echo $value; else echo "Not Available";?></td> 
									                  </tr>
													  
													  <tr class="row_color">
										                
										                  <td align="left"><a  class="tablehead"><span class="sideheading">Blog Review</span></a></td>
                                                        <td align="left">:</td>
									                    
                                                      <td  height="24" align="left" ><?php echo $val['review_desc'];?></td>
									                  </tr>
													 <tr class="row_color">
										                
										                  <td align="left"><a  class="tablehead"><span class="sideheading">Review Rating</span></a></td>
                                                       <td align="left">:</td>
									                    
                                                      <td  height="24" align="left" ><?php echo $val['review_rating'];?></td>
									                  </tr>
													</table>
											  </td>
											</tr>
