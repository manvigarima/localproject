	...
	if(!empty($_POST))
	{
		...
		if($count == '0')
		{
			...
			{	
				...
				$tab = array("career_name =".$_POST['txttitle']."", "career_desc=".addslashes($_POST['desc'])."", "pdf = ".$upload."", "create_date =$date","status =".$_POST['status']."");
				$val = $qatar_career->qatar_career_insert($tab);
				$_SESSION['msg'] = "<font size='2' color='#0099FF'>Career Added Successfully</font>";
				print "<script>";
		...
		{
			$_SESSION['msg'] = "<font  size='2' color='#0099FF' class = 'linkl'>careers Title Already Existed</font>";
		}
	}
...
<script language="javascript">
	function check(){
		...
		getForm("new_news");
		if(!IsEmpty("txttitle","Please Provide News Title"))return false;
    ...
    <br class="clear"/> 
		...
		<div id="content_wrapper" style="margin-right:30px;"> 
			...
			<ul class="first_level_tab"> 
				...
				<li> 
					<a href="<?php echo $admin_path;?>careers/career_new.php"  class="active"> 
						Add Careers
					</a> 
				</li> 
			</ul>	
		...
		<form action="#" method="post" name="new_news" onsubmit="return check()" enctype="multipart/form-data">
									<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" class="global">
                                      ...
                                      <tr>
												<td align="center" colspan="6"><h2>Add Career</h2></td>
											</tr>
											<tr>
												...
												<td colspan="6">
													<table width="100%" border="0" style="line-height:30px;" cellpadding="3" cellspacing="1" class="tborder">
									                  ...
									                  <tr>
														  ...
														  <td width="2%">:</td>
														  <td width="56%"><input type="text" value="<?php if(!empty($_POST)){echo $_POST['txttitle'];}?>" name="txttitle" id="txttitle" size="35"/></td>
										              </tr>
													  <tr>
                                                        ...
                                                        <tr>
										                  <td width="42%" height="24" align="right" >Upload Pdf</td>
														  <td width="2%">:</td>
													  ...
													  <tr>
													  	<td colspan="3" align="center" bgcolor="#D8D8F3">
											            	<input type="submit" name="add_new" value="Add Career" class="button" id="add_new">
