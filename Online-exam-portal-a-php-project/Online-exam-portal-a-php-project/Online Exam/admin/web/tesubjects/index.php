...
$subj=new Tesubjects();
	...
	$totalEntries=$subj->totalNoOfsubjs($al);
	...
	$rec = $subj->display_subjs($page,$al,$order);
...
function addBlog()
	{
		...
		return false;
		javascript:location.href=('subj_add.php');
	}
		function hidediv(){
...
<body>
	<form name="pageSelectionForm" id="pageSelectionForm" method="post" action="../tesubjects/index.php">
    ...
    <br class="clear"/> 
		...
		<div id="content_wrapper" style="margin-right:30px;"> 
			...
			<div style="border:1px solid #ccc;"  > 
				...
				<form name="BlogSelectionForm" method="post" action="../tesubjects/delete_subj.php?al=<? echo $_REQUEST['al'];?>&amp;page=<? echo $page; ?>">
									<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" class="global">
									  ...
									  <!--	<tr>
											...
											<tr>
												...
												?>        
                                                <input type="button" name="sub1" value="Add Subject" class="button_light"   onclick="return addBlog()" />
									                <input type="submit" name="sub3" value="Delete Subject" class="button_light" onclick="doselect1(); return false;" />
											...
											<tr>
												<td colspan="5" align="center">
													<table width="50%" align="center" border="0" cellpadding="3" cellspacing="1" class="tborder">
                                                                                            

                  										<tr class="row_1"><?php $_GET['or']?>
										                    <th width="5%" align="center" >
                                                            <input type="checkbox" name="allChk" value="ON" onclick="CheckAll(this);"  class="input2" /></th>
									                      <th width="43%" align="left" ><a href="../coures/index.php?order=<?php if(empty($_GET['order'])){?>1<?php }elseif($_GET['order'] == '1'){?>0<?php }?>" class="tablehead">Subject<span class="style1"> </span></a>&nbsp;<?php if($_GET["order"]=='0') {?><img src="../images/up1.GIF" width="13" height="13" /><?php }else if($_GET["order"] == '1'){?><img src="../images/down1.GIF" width="13" height="13" /><?php }?></th>
													  ...
													  <tr class="row_white">
                                                          ...
                                                          id="<?php echo $row['sub_id'];?>" value="642" class="input2" /></td>
									                    <td align="left">
                                                       
                                                        
                                                        <a  href="subj_modify.php?sid=<?php echo $row['sub_id'];?>&page=<?php echo $_REQUEST['pageNumber'];?>&<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."";} ?>">
                                                        
														<?php echo $row['sub_name'];?></a>                                                       </td>
                                                           
                                                   <td align="left"><img src="../../../subimages/<?php echo $row['sub_image'];?>" width="60" height="60" /></td>
													  ...
													  ?>
													  <tr class="row_color">
										                  <td height="24" align="center" ><input  type="checkbox" name="Mid[]" id="<?php echo $row['sub_id'];?>" value="642" class="input2" /></td>
														  <td align="left">
														    <a  href="subj_modify.php?sid=<?php echo $row['sub_id'];?>&page=<?php echo $_REQUEST['pageNumber'];?>&<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."";} ?>">
														   <?php echo $row['sub_name'];?>                                                           </a> </td>
                                                           
                                                   <td align="left">
                                                     <img src="../../../subimages/<?php echo $row['sub_image'];?>" width="60" height="60" />	</td>
