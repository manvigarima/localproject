...
$al=".";
	...
	$feedback1=new NewsletterUsers();
	
	$totalEntries=$feedback1->totalNoOfNewsletterusers($al,$_SESSION['school_id']);
	...
	$rec = $feedback1->display_newsletterusers($page,$order,$al,$_SESSION['school_id']);	
...
<body>
    ...
    <?php  include '../left.php'; ?>
		...
		<ul class="first_level_tab"> 
				<li> 
					<a href="<?php echo $admin_path;?>newsletter/index.php" class="active"> 
						Manage Newsletters
					</a> 
				</li>
												...
												<td colspan="5">
													<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tborder">
                  									  ...
                  									  <tr class="row_1">
										                    ...
										                    <th width="15%" align="left" >Mail Id</th>
													  ...
													  <tr class="row_white">
                                                          ...
                                                          <input  type="checkbox" name="Mid[]" id="<?php echo $row['fb_id'];?>" value="642" class="input2" /></td>
														  <td align="left">
														    <?=$row['email_id']?>														</td>
									                    ...
									                    <td align="left">
                                                          ...
                                                          <a href="action.php?<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."&";}if(!empty($_REQUEST['or'])){echo "or=".$_REQUEST['or']."&";}?>id_1=<?=$row['ns_id']?>&id=<?=$row['ns_id']?>&state=<?php echo $row['status'];?>&page=<?php echo $page; ?>&order=<?php echo $order;?>">
														  <?php 
														  ...
														  echo"Inactive";
														  ?></a>
                                                          <a href="action.php?<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."&";}if(!empty($_REQUEST['or'])){echo "or=".$_REQUEST['or']."&";}?>id=<?php echo $row['fb_id']?>&state=<?php echo $row['status'];?>&page=<?php echo $page; ?>&order=<?php echo $order;?>"></a></td> 
									                  </tr>
													  <?php }
													  		else if($val == '1')
															{
													  ...
													  ?>
													  <tr class="row_color">
										                  <td height="24" align="left" ><input  type="checkbox" name="Mid[]" id="<?php echo $row['fb_id '];?>" value="642" class="input2" /></td>
														  <td align="left"><a href="edit.php?id=<?php echo $row['fb_id '];?>">
														   <?=$row['email_id ']?>
														</a></td>
										                  
										                
									                    <td align="left">
                                     <a href="action.php?<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."&";}if(!empty($_REQUEST['or'])){echo "or=".$_REQUEST['or']."&";}?>id_1=<?=$row['ns_id']?>&id=<?=$row['ns_id']?>&state=<?php echo $row['status'];?>&page=<?php echo $page; ?>&order=<?php echo $order;?>"><?php 
														  if($row['status']=="active")
														  echo"Active";
														  else
														  echo"Inactive";
                                            	...
                                            	<tr>
														<td colspan="5"  class="row_white" align="right"></td>
						  </tr>
