...
<?php 
	...
	if(!empty($_POST))
	{
	 $sq = "SELECT country_id FROM ise_country WHERE country_name= '".$_POST['txttitle']."'";
	//echo $sq;exit;
	$objSql = new SqlClass();
		...
		if(empty($row13['country_id']))
		{
				...
				$val = $country->country_insert($tab);
				$_SESSION['msg'] = "<div class='success'>Country Added Successfully</div>";
				print "<script>";
...
<script language="javascript">
	...
	{
		getForm("group_new");
		if(!IsEmpty("txttitle","Provide Country Name"))return false;
    ...
    <br class="clear"/> 
		...
		<div id="content_wrapper" style="margin-right:30px;"> 
			...
			<ul class="first_level_tab"> 
				...
				<li> 
					<a href="<?php echo $admin_path;?>otherotions/new.php" class="active"> 
						 Add Country
					</a> 
				</li> 
