...
<?php 
	...
	if(!empty($_POST))
	{
				...
				$val = $city->city_update_function($tab,$where);
				$_SESSION['msg'] = "<font size='2' color='#FF0000'>City details updated Successfully</font>";
				$page=$_REQUEST['page'];
				$al=$_REQUEST['al'];
				print "<script>";
				print " self.location='city_index.php?pageNumber=".$page."&al=".$al."'";
				print "</script>"; 
	
	}
	$row = $city->city_select_one($_GET['id']);
	/*echo"<pre>";
	print_r($row);*/
?>
    ...
    <br class="clear"/> 
		...
		<div id="content_wrapper" style="margin-right:30px;"> 
			...
			<ul class="first_level_tab"> 
				...
				<li> 
					<a href="<?php echo $admin_path;?>otherotions/city_new.php"> 
						 Add City
					</a> 
				</li> -->
		...
		<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" class="global">
									    ...
									    <tr><td colspan="3"><?php // echo $_SESSION['msg']; if(!empty($_SESSION['msg']))unset($_SESSION['msg']);?></td></tr>
                                            ...
                                            <tr>
												<td align="center" colspan="6"><h2>Modify City</h2></td>
										  </tr>
											<tr>
												<td colspan="6">
                        ...
                        <input type="hidden" name="page" value="<?php echo $_GET['page'];?>" />
													<table width="100%" border="0" style="line-height:30px;" cellpadding="3" cellspacing="1" class="tborder">
									                  ...
									                  <tr>
									                    ...
									                    <td>:</td>
									                    <td>
                                                        <?php $x=$state->state_select_one($row[0]['stateid']); 
														echo   $state->get_state1($x[0]['country_id'],$row[0]['stateid']);;?></td>
								                      </tr>
													   <tr>
									                    <td height="24" align="right" ><label><font size="4" color="#ff0000"><b>
                                                          *</b></font>City Name </label></td>
									                    <td>:</td>
									                    <td><input type="text" name="cityid"  value="<?php echo $row[0]['city_name']?>"/>
                                                       </td>
								                      </tr>
