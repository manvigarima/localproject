...
$al=".";
	...
	$ads=new ads();
	$totalEntries=$state->totalNoOfstate($al);
	...
	$rec = $state->display_state($page,$al);	
...
<script language="javascript">
	...
	function addclients()
	{
		...
		if(!confirm('Are you sure you want to add the State?\n- to Add the  Client, hit OK\n- otherwise, hit Cancel'))
		return false;
		javascript:location.href=('state_new.php');
	}
	 function export1()
	{
		dml1=document.client;
		...
		location.href='export_state.php?exprt='+val12;
		return true;
...
<body>
	<form name="pageSelectionForm" id="pageSelectionForm" method="post" action="state_index.php">
    ...
    <?php  include '../left.php'; ?>
		...
		<div id="content_wrapper" style="margin-right:30px;"> 
			...
			<ul class="first_level_tab"> 
				<li> 
					<a href="<?php echo $admin_path;?>otherotions/state_index.php" class="active" style="cursor:pointer" > 
						Manage State
					</a> 
				</li>
				<li> 
					<a href="<?php echo $admin_path;?>otherotions/state_new.php" style="cursor:pointer"  onclick="return addclients();"> 
						 Add State
					</a> 
				</li> 
			...
			<div style="border:1px solid #ccc;"  > 
				...
				<div class="content nomargin"  > 
                  ...
                  <form name="client" method="post" action="state_action.php?al=<? echo $_REQUEST['al'];?>&page=<? echo $page; ?>">
						 ...
						 <tr><td width="100%" colspan="5"><b><font color="#ff0000"><?php echo $_SESSION['msg']; if(!empty($_SESSION['msg']))unset($_SESSION['msg']);?></font></b></td></tr>
											<tr>
												...
												?>     
									               ...
									               <input type="submit" name="sub3" value="Delete State" class="button_light" onclick="doselect1(); return false;" style="cursor:pointer"/>
											...
											<tr>
												<td colspan="5" align="center">
													<table width="50%" border="0" cellpadding="0" cellspacing="0" class="tborder">
													  ...
													  ?>
													  <tr class="row_white">
										                  <td height="24" align="left" ><input  type="checkbox" name="Mid[]" id="<?php echo $row['stat_id'];?>" value="642" class="input2" /></td>
														  <td align="left">
														    <? $x=$row['stat_name']; ?>
														<? echo $x; ?></a>
                                                        </td>
										                 <td align="left">
														    <?php $x=$country->country_select_one($row['country_id']); echo $x[0]['country_name']?>
														
                                                        </td>
										                  <td align="left">
                                                         
                                                          <a href="state_edit.php?id=<?php echo $row['stat_id'];?>&page=<?php echo $page; ?>&<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."";} ?>"><img src="../images/b_edit.png">
														 </a>
                                                          </td> 
									                  </tr>
													  <?php }
													  ...
													  <tr class="row_color">
										                  <td height="24" align="left" ><input  type="checkbox" name="Mid[]" id="<?php echo $row['stat_id'];?>" value="642" class="input2" /></td>
														  <td align="left">
														  <?  $x=$row['stat_name']; ?><? echo $x; ?></td>
										                   <td align="left">
														 <?php $x=$country->country_select_one($row['country_id']); echo $x[0]['country_name']?></td>
										                  <td align="left">
                                                           <a href="state_edit.php?id=<?php echo $row['stat_id'];?>&page=<?php echo $page; ?>&<?php if(!empty($_REQUEST['al'])){echo "al=".$_REQUEST['al']."";} ?>"><img src="../images/b_edit.png">
														 </a>
                                     						</td> 
