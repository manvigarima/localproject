<?php 
	...
	$total = $row['vote_opt_one']+$row['vote_opt_two']+$row['vote_opt_three'];
	if($total==0)
	{
		$vote1='0';$vote2='0';$vote2='0';
	}else{
		$vote1 = round($row['vote_opt_one']*100/$total);
		$vote2 = round($row['vote_opt_two']*100/$total);
		$vote3 = round($row['vote_opt_three']*100/$total);
	}
    ...
    <br class="clear"/> 
		...
		<div id="content_wrapper" style="margin-right:30px;"> 
			...
			<ul class="first_level_tab"> 
				...
				<li> 
					<a href="<?php echo $admin_path;?>polls/news_new.php"> 
						Add Poll
					</a> 
				</li> 
			</ul>	
											...
											<tr>
												<td colspan="5">
													<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tborder">
                                                     <tr width="18%" align="left"  >
                                                    
                                                    <td  colspan="2" class="line_bdr" width="97%" >
                                                    <a class="tablehead">
                                                    <b><?=ucfirst($row['poll_title']);?></b>
                                                    </a></td>
                                                    </tr>  
                                                    <tr>
                                                        <td width="25%" ><?=ucfirst($row['option_one'])?></td>
                                                        <td><img src="../images/blue.gif" width="<?=$vote1?>" height="10">&nbsp;&nbsp;<?=$vote1?>%</td>
                                                    </tr>  
                                                    <tr>
                                                        <td width="25%" ><?=ucfirst($row['option_two'])?></td>
                                                        <td><img src="../images/green.gif" width="<?=$vote2?>" height="10">&nbsp;&nbsp;<?=$vote2?>%</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="25%" ><?=ucfirst($row['option_three'])?></td>
                                                        <td><img src="../images/aqua.gif" width="<?=$vote3?>" height="10">&nbsp;&nbsp;<?=$vote3?>%</td>
                                                    </tr>
