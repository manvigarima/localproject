...
<!-- Header Row Content -->
<?php
include_once 'includes/header_school.php';
?>
<!-- Header Row Content -->
...
<tr>
   <td colspan="3" bgcolor="#FFFFFF" class="sprite_padding_1">
	...
	?>
          <tr>
            <td colspan="3"><img src="ads/<?php echo $row['url'];?>" width="197" height="133" /></td>
          </tr>
          <?php
		  }
		  ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:3px;">
          <tr>
			...
			?>
            <img src="ads/<?php echo $row['url'];?>" width="523" height="251" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="3"><table width="522" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="82"><img src="images/sci_active.jpg" width="82" height="30" /></td>
                  <td width="84" align="left"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image61','','images/phy_active.jpg',1)"><img src="images/phy_normal.jpg" name="Image61" width="84" height="30" border="0" id="Image61" /></a></td>
                  <td width="103" align="left"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image62','','images/che_active.jpg',1)"><img src="images/che_normal.jpg" name="Image62" width="103" height="30" border="0" id="Image62" /></a></td>
                  <td width="111" align="left"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image63','','images/mat_active.jpg',1)"><img src="images/mat_normal.jpg" name="Image63" width="111" height="30" border="0" id="Image63" /></a></td>
                  <td width="144" style="border-bottom:#ce3918 solid 1px;">&nbsp;</td>
                </tr>
            </table></td>
          </tr>
          <tr>
            <td colspan="3" class="sprite_padding_1" style="border-bottom:#ce3918 solid 1px;border-left:#ce3918 solid 1px;border-right:#ce3918 solid 1px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <td valign="top"><table width="197" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td colspan="3" background="images/sprite_14.jpg" class="sprite_padding_1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="22" align="left" valign="top" class="sprite_font_1"><strong>Search</strong></td>
                      </tr>
                      <tr>
                        ...
                        <td height="20"><table width="181" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td><table border="0" cellpadding="0" cellspacing="0" width="180">
                                  <tbody>
                                    <tr>
                                      <td background="brian_cert_files/dotline.gif" width="1"><img src="brian_cert_files/spacer.gif" border="0" /> </td>
                                      <td width="156"><img src="brian_cert_files/blueArrow.gif" border="0" /> <font color="#ff6600">&nbsp;</font><b><font color="#ff6600">Exam Search</font></b> </td>
                                    </tr>
                                    <tr>
                                      <td background="brian_cert_files/dotline.gif" width="1"><img src="brian_cert_files/spacer.gif" border="0" /> </td>
                                      <td style="margin: 2px; padding: 2px;" width="156">&nbsp;
                                          <table border="0" cellpadding="3" cellspacing="0" width="100%">
                                            <tbody>
                                              <tr>
                                                <td><img src="brian_cert_files/pixel_trans.gif" alt="" border="0" width="100%" height="1" /></td>
                                              </tr>
                                              <tr>
                                    ...
                                    <tr>
                                      <td colspan="2" background="brian_cert_files/dot2.gif" height="3"></td>
                                    </tr>
                                  </tbody>
                              </table></td>
                            </tr>
                            <tr>
                              <td><table border="0" cellpadding="0" cellspacing="0" width="160">
                                  <tbody>
                                    <tr>
                                      <td background="brian_cert_files/dotline.gif" width="1"><img src="brian_cert_files/spacer.gif" border="0" /> </td>
                                      <td width="156"><img src="brian_cert_files/blueArrow.gif" border="0" /> <font color="#ff6600">&nbsp;</font><b><font color="#ff6600">Latest Forum Topics</font></b> </td>
                                    </tr>
                                    <tr>
                                      <td background="brian_cert_files/dotline.gif" width="1"><img src="brian_cert_files/spacer.gif" border="0" /> </td>
                                      <td style="margin: 2px; padding: 2px;" width="156">&nbsp;<br />
										...
										?>
                                          <img src="brian_cert_files/icon_mini_message.gif" alt="" border="0" /><b><font color="#000000"><a href="forums_inner.php?fid=<?=$rec[$start]['forum_id']?>" class="sidetextblue"><?=$rec[$start]['forum_name']?></a><br />
...
<!-- Footer Row Content -->
<?php
include_once 'includes/footer_school.php';
?>
<!-- Footer Row Content -->
