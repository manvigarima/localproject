...
// $group=new ise_groups();
 ...
 if($_SESSION['user_id']!=''){
  $group1=new ise_groups();
  $rec=$group1->get_active_mygroups($_SESSION['school_id'],$_SESSION['user_id']);
  }
...
?>        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
                  ...
                  <td width="73%" background="images/ismart_48.jpg" style="border-right:#dadada solid 1px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="40%" height="30" class="top_link"><a href="groups_inner.php?group_id=<?php echo $rec[$i]['group_id'];?>"><strong><?php echo $totalnoofcomments;?> comments </strong></a></td>
                         <td width="40%" height="30" class="top_link"><a href="groups_inner.php?group_id=<?php echo $rec[$i]['group_id'];?>"><strong><?php echo 
          ...
          if(count($rec)>6){
			?>
            <div align="right"><a href="viewall_mygroup.php" class="page_txt1"/> More &raquo;&raquo;</a></div>
            <?php }?>
            </td>
          </tr>
