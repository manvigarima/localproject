...
class Contact{
	...
	function qatar_scimages_insert($array){
	...
	function contact_set_function($array,$where){
	...
	function qatar_clients_update($array,$where){
	   return $this->query->makeupdatequery($this->table,$array,$where);	
	}
	function qatar_groups_comm_update($array,$where){
	   return $this->query->makeupdatequery($this->table_cat,$array,$where);	
	}
	function contact_groups_delete($field,$value){
	...
	function qatar_scimages_selectall($field,$value){
