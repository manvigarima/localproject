...
class scroll_text{
    ...
    function __construct(){
	  ...
	  $this->table='scroll_text';
	  $this->table_cat='category';
	  $this->table_mem='group_members';
      $this->query=new Queries();
	}
	function qatar_scroll_text_insert($array){
	...
	function qatar_scroll_text_set_function($array,$where){
	...
	function qatar_scroll_selectall($field,$value){
