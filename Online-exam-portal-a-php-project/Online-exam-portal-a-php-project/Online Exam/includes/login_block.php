...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="22" align="left" class="sprite_font_4"><span class="sprite_font_5"><a href="my_profile.php" class="sprite_font_4" style="text-decoration:none;"><strong>My Profile</strong></a>&nbsp;|&nbsp;<a href="javascript:void();" class="sprite_font_4" style="text-decoration:none;" onclick="loadwindow('edit_profile.php','800','500')"><strong>Edit Profile</strong></a></span></td>
  </tr>
          <tr>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="login_form" name="login_form" method="post" enctype="multipart/form-data" onsubmit="javascript:return login_form_check();">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td colspan="2" align="left" class="sprite_font_4"><a href="#" class="sprite_font_5" style="text-decoration:none;"><strong>Forgot Password?</strong></a></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
