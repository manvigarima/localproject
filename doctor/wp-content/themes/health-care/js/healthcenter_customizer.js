jQuery(document).ready(function() {
	...
	/* service panel */
	wp.customize.section( 'sidebar-widgets-health-care-sidebar-service' ).panel( 'service_panel' );
	wp.customize.section( 'sidebar-widgets-health-care-sidebar-service' ).priority( '3' );
