/*----------------------------------------------------------------------------*/
/* VW Hospital Lite Responsive WordPress Theme */
/*----------------------------------------------------------------------------*/
...
3 - Images used from Pixabay.
	...
	Bundled header image, Copyright sasint
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pixabay.com/en/asia-assistance-care-for-caretaker-1807539/

All the icons taken from genericons licensed under GPL License.
http://genericons.com/

VW Hospital Lite version
==========================================================
VW Hospital Lite version is compatible with GPL licensed.
