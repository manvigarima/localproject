    ...
    <div class="<?php if( is_active_sidebar('sidebar-primary')) { echo "col-md-8"; } else { echo "col-md-12"; } ?>">
      ...
      <div class="hc_blog_pagination">
        <div class="hc_blog_pagi">
          <?php previous_posts_link( __('<span class="meta-nav">&larr;</span> Older posts','health-center-lite') ); ?>
		  <?php next_posts_link( __('<span class="meta-nav">&larr;</span> Newer posts','health-center-lite'), $post_type_data->max_num_pages ); ?>
		</div>
      </div>
    </div>
    <?php get_sidebar(); ?>
