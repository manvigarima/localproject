        ...
        <div class="hc_post_title_wrapper">
          ...
          <div class="hc_post_detail">
            <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><i class="fa fa-user"></i><?php echo get_the_author(); ?></a>
             <a href="<?php get_comment_link('ID'); ?>"><i class="fa fa-comments"></i><?php comments_popup_link( __( "Leave a comment", 'health-center-lite' ),__( "One Comment", 'health-center-lite' ), __( "% Comments", 'health-center-lite' ),'name' ); ?></a>
