...
<div class="container">
  <div class="row">
    <div class="hc_page_header_area">
      <h1><?php if ( is_day() ) : ?>
        <?php  _e( "Daily Archive", 'health-center-lite' ); echo (get_the_date()); ?>
        <?php elseif ( is_month() ) : ?>
        <?php  _e( "Monthly Archive", 'health-center-lite' ); echo (get_the_date( 'F Y' )); ?>
        <?php elseif ( is_year() ) : ?>
        <?php  _e( "Yearly Archive", 'health-center-lite' );  echo (get_the_date( 'Y' )); ?>
        <?php else : ?>
        <?php _e( "Blog Archive", 'health-center-lite' ); ?>
        <?php endif; ?>
      </h1>
    </div>
  </div>
