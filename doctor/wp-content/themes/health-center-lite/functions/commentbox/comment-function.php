          ...
          <div class="media hc_comment_box">
           ...
           <div class="media-body">
			   <div class="hc_comment_detail">
				<h4 class="hc_comment_detail_title"><?php the_author();?><span><?php the_time('F j, Y');?>&nbsp;<?php _e('at','health-center-lite');?>&nbsp;<?php the_time('g:i a'); ?></span></h4>
