...
class WP_demo_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo 'http://webriti.com/demo/wp/healthcentre/';?>" target="_blank" class="demo" id="review_pro">
	 <?php _e( 'View Demo','health-center-lite' ); ?></a>
	 </div>
    <?php
    }
}
...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo 'http://webriti.com/healthcentre/';?>" target="_blank" class="upgrade" id="review_pro">
	   <?php _e('Upgrade to pro','health-center-lite' ); ?></a>
...
$wp_customize->add_section( 'health_pro_section' , array(
		'title'      => __('Upgrade to pro', 'health-center-lite'),
		'priority'   => 1150,
   	) );
...
class WP_Review_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo 'https://wordpress.org/support/view/theme-reviews/health-center-lite#postform/';?>" target="_blank" class="review" id="review_pro"><?php _e('ADD YOUR REVIEW','health-center-lite' ); ?></a>
	 </div>
    <?php
    }
}
...
class WP_document_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
      <div class="pro-box">
 <a href="<?php echo 'http://webriti.com/help/';?>" target="_blank" class="document" id="review_pro"><?php _e('DOCUMENTATION','health-center-lite' ); ?></a>
