  ...
  <div class="row">
    <div class="col-md-12 hc_404_error_section">
      <div class="error_404">
        ...
        <p><?php _e('We are sorry, but the page you are looking for does not exist.','health-center-lite'); ?></p>
        <p><a href="<?php echo esc_html(site_url()); ?>" class="error_404_btn"><?php _e('Go Back','health-center-lite'); ?></a></p>
      </div>
    </div>
  </div>
</div>
